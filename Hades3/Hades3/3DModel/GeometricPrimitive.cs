...
namespace Hades3
{
    ...
    public abstract class GeometricPrimitive : IDisposable
    {
        ...
        /// you call it.
        /// </summary>
        public void Draw(Matrix view, Matrix projection, Color color, Vector3 position)
        {
        ...
        public void Draw(Matrix view, Matrix projection, Color color, Vector3 position, Matrix transformationMatrix)
        {
            Matrix worldMatrix = transformationMatrix * Matrix.CreateTranslation(position);
